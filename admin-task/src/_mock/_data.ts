...
export const _myAccount = {
  ...
  photoURL: "/assets/avatar/avatar-1.webp",
};
...
export const _products = [...Array(24)].map((_, index) => {
  ...
  return {
    ...
    coverUrl: `/assets/product/product-${setIndex}.webp`,
    colors:
...
export const _langs = [
  {
    value: "en",
    label: "English",
    icon: "/assets/flags/ic-flag-en.svg",
  },
  {
    value: "de",
    label: "German",
    icon: "/assets/flags/ic-flag-de.svg",
  },
  {
    value: "fr",
    label: "French",
    icon: "/assets/flags/ic-flag-fr.svg",
  },
];
...
export const _notifications = [
  ...
  },
  {
    ...
    avatarUrl: "/assets/avatar/avatar-2.webp",
